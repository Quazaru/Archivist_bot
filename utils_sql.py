...
class DBHandler:
    ...
    def table_select(self, table_name, condition_tuple=(), orderByField=None, isDESC=False) -> list[dict]:
        query = self._queryHelper.generate_query_select(table_name, condition_tuple, orderByField, isDESC)
        self._cursor.execute(query)
